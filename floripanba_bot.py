    ...
    if opp_tricode:
        ...
        if dr_rank:
            if side == "over":
                if dr_rank >= 25:
                    adj = +8
                    adjustments.append("rival def débil +8")
                elif dr_rank >= 20:
                    adj = +4
                    adjustments.append("rival def floja +4")
                elif dr_rank <= 5:
                    adj = -8
                    adjustments.append("rival def élite -8")
                elif dr_rank <= 10:
                    adj = -4
                    adjustments.append("rival def buena -4")
                else:
                    adj = 0
            else:  # under
                if dr_rank <= 5:
        ...
        if pace_rank:
            if side == "over":
                if pace_rank <= 5:
                    adj = +5
                    adjustments.append("ritmo alto +5")
                elif pace_rank >= 25:
                    adj = -5
                    adjustments.append("ritmo lento -5")
                else:
                    adj = 0
            else:
                if pace_rank >= 25:
